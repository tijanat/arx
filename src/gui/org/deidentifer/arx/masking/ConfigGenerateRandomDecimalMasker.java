 ...
 *
 */
public class ConfigGenerateRandomDecimalMasker extends ChangeableComposite{
	 ...
	 * @param y
	 */
	public ConfigGenerateRandomDecimalMasker(Composite s, int x, int y) {
		super(s);
		group.setText("Generate random decimal");
